    ...
    platformSelect({
      android: (
        <View style={styles.androidContainerStyle}>
          <StatusBar animated={false} backgroundColor="transparent" translucent={true} barStyle="dark-content" />
      ...
      ios: (
        <View style={styles.iosContainerStyle}>
          <StatusBar animated={false} backgroundColor='transparent' translucent={true} barStyle='dark-content' />
          <Image style={styles.imgStyle} source={require('../assets/images/welcome/start_screen_icon.png')} />
