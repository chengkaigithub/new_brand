...
function toastInject(): Function {
  return function(WrappedComponent: ComponentClass) {
    class WithSubscription extends Component {
      static displayName = `ToastWithSubscription(${WrappedComponent.displayName ||
